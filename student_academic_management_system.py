...
# Display report
college.display_details()class Student:
    TOTAL_FEE = 90000
    def __init__(self, sid, name, m1, m2, m3, birth_year, fee_paid):
        self.sid = sid
        self.name = name
...
# Creating student objects
s1 = Student(14, "B.Hima Sri", 85, 78, 90, 2006, 50000)
s2 = Student(7, "aadhya", 88, 92, 80, 2007, 45000)
s3 = Student(23, "krishna", 70, 75, 68, 2007, 20000)
